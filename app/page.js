...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Close">
  <div className="morningBriefFlag"><span>THE SUNDAY CLOSE <i>MONDAY PENDING</i></span><small>SEPTEMBER 20 • WEEK 2</small></div>
  <div className="sundayFrontGrid">
    <Link href="/articles/hollis-body-keeps-score" className="sundayFeature storylink">
      <div className="sundayFeatureImage sundayActionHero"><img src="/images/editorial/hollis-body-score.jpg" alt="A rainy fantasy-football night with an injured player on television and a live matchup on a phone"/><div className="actionCaption">HOLLIS CRANE • SUNDAY NIGHT</div></div>
      <div className="sundayFeatureCopy"><small>HOLLIS CRANE • FIELD NOTES</small><h2>The Body Keeps the Real Score</h2><p>Fantasy football gives us a contained place to pretend control exists. Then a hamstring goes. An elbow bends. And the structure reveals itself.</p><PreviewAuthor slug="hollis-body-keeps-score"/><span>READ THE SUNDAY FILE →</span></div>
    </Link>
    <div className="sundaySide sundayStoryCarousel" aria-label="Sunday night supporting stories">
      ...
      <Link href="/articles/hollis-uprights-reality" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/private/t_editorial_landscape_12_desktop/patriots/nqhne57rv5nnboinmypz" alt="A field goal attempt at Gillette Stadium"/><b>NATIONAL DESK • OPTICAL GOVERNANCE</b></div><small>HOLLIS CRANE • INVESTIGATIONS</small><h3>The NFL Has Standardized Reality Behind the Uprights</h3><p>A new league rule says both teams must now inhabit the same visual universe during field goals.</p><span>READ →</span></Link>
    </div>
  </div>
</section>
