...
<section className="hero heroStack" id="league"><Link className="hero-copy storylink" href="/articles/sabine-chest-statement"><div className="photoHero" style={{backgroundImage:"linear-gradient(0deg,rgba(0,0,0,.38),rgba(0,0,0,.06)),url('/images/staff/sabine-march.webp')",backgroundPosition:"center 20%"}}><div><small>SABINE MARCH • PUBLIC LIFE</small><b>Official statement</b><strong>—</strong><span>NO DENIAL ISSUED</span></div></div><div className="eyebrow">MATTERS OF CULTURE • PUBLIC LIFE</div><h2>A Brief Statement Regarding <em>Ongoing Chest Speculation.</em></h2><PreviewAuthor slug="sabine-chest-statement"/><p className="standfirst">Sabine declines to provide measurements, commission an independent review, or deny the central allegation.</p><div className="read">READ THE STATEMENT →</div></Link></section>
