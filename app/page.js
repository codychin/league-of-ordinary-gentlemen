...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    <Link href="/articles/route-22-phones" className="sundayFeature storylink">
      <div className="sundayFeatureImage sundayActionHero"><img src="https://images2.minutemediacdn.com/image/upload/c_crop,x_2130,y_339,w_3461,h_1946/c_fill,w_1200,ar_16:9,f_auto,q_auto,g_auto/images/ImagnImages/mmsport/raiders_today/01kj5k7mkkwysdd6vm74.jpg" alt="Ashton Jeanty carrying the ball"/><div className="actionCaption">ROUTE 22 • SUNDAY FILE</div></div>
      <div className="sundayFeatureCopy"><small>DASHIELL PIKE • ROUTE 22</small><h2>Route 22 Won Week 1. The Phones Somehow Stayed Open.</h2><p>Ashton Jeanty gave the Clubhouse 39. James Cook added 27 before Sunday even started. At some point the roster has to become a football team.</p><PreviewAuthor slug="route-22-phones"/><span>READ THE SUNDAY FILE →</span></div>
    </Link>
