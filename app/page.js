...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    ...
    <div className="sundaySide sundayStoryCarousel" aria-label="Sunday supporting stories">
      ...
      <Link href="/articles/sabine-all-ugly-lloyd" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://images2.minutemediacdn.com/image/upload/c_crop,x_2130,y_339,w_3461,h_1946/c_fill,w_1200,ar_16:9,f_auto,q_auto,g_auto/images/ImagnImages/mmsport/raiders_today/01kj5k7mkkwysdd6vm74.jpg" alt="NFL game action"/><b>STORY 3 • GAME FILE</b></div><small>SABINE MARCH • ALL UGLY–LLOYD</small><h3>Thursday Made the Closest Game on the Board Even Closer</h3><p>Amon-Ra and Kincaid have already traded 59.7 points. The projection is separated by less than one.</p><span>READ →</span></Link>
      <Link href="/articles/conrad-danir-ceedeep-hole" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/upload/t_landscape_tablet/commanders/qebhl0lmhunlez1xfpk8.png" alt="NFL game action"/><b>STORY 4 • EARLY DAMAGE</b></div><small>CONRAD SORRELL • DANIR–CEEDEEP</small><h3>Danir Hasn't Reached Sunday and Is Already Down 29.12</h3><p>Gibbs answered. The problem is that CeeDeep started Thursday with 53.02.</p><span>READ →</span></Link>
    </div>
  </div>
  <SundayLiveDesk/>
</section>
