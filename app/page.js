...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    <Link href="/articles/hollis-kash-folder" className="sundayFeature storylink">
      <div className="sundayFeatureImage athleteFeature"><img src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['hopkins-opus']))} alt="Hopkins Opus featured player"/><img className="featureOpponent" src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['royrek']))} alt="Royrek featured player"/><div className="evidenceStamp">HOPKINS–ROYREK<br/>SUNDAY • 1:00 PM</div></div>
      <div className="sundayFeatureCopy"><small>HOLLIS CRANE • HOPKINS–ROYREK</small><h2>Kash Has 181.60 Points of Evidence. Royrek Gets the Cross-Examination.</h2><p>Week 1 gave Hopkins Opus the league’s biggest score and Kash something more dangerous: a documented reason to believe himself. Royrek gets first crack at the sequel.</p><PreviewAuthor slug="hollis-kash-folder"/><span>READ THE MATCHUP FILE →</span></div>
    </Link>
    <div className="sundaySide">
      ...
      <Link href="/articles/dashiell-route-22-portfolio" className="sundaySideStory storylink"><div className="sideImage athleteSide"><img src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['route-22']))} alt="Route 22 featured player"/><b>CAPITAL DESK</b></div><small>DASHIELL PIKE • ROUTE 22</small><h3>James Cook Banked 27. Route 22 Can Finally Stop Negotiating for a Few Hours.</h3><p>The Clubhouse has an early lead, a 1–0 record and, for once, an actual game to manage.</p><span>FOLLOW THE MONEY →</span></Link>
    </div>
  </div>
