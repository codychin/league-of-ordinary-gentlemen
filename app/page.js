...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    ...
    <div className="sundaySide sundayStoryCarousel" aria-label="Sunday supporting stories">
      ...
      <Link href="/articles/conrad-kupp-kraft-keenan" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://a.espncdn.com/i/headshots/nfl/players/full/3915416.png" alt="DJ Moore"/><b>STORY 3 • ROSTER MOVE</b></div><small>CONRAD SORRELL • KUPP–KRAFT</small><h3>Kupp Kupp Doubs Added Keenan Allen at Breakfast</h3><p>DJ Moore's shoulder explains the timing. Puka's Monday status keeps the other side interesting.</p><span>READ →</span></Link>
      <Link href="/articles/conrad-danir-ceedeep-hole" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://a.espncdn.com/i/headshots/nfl/players/full/4429795.png" alt="Jahmyr Gibbs"/><b>STORY 4 • EARLY DAMAGE</b></div><small>CONRAD SORRELL • DANIR–CEEDEEP</small><h3>Danir Hasn't Reached Sunday and Is Already Down 29.12</h3><p>Gibbs answered. The problem is that CeeDeep started Thursday with 53.02.</p><span>READ →</span></Link>
    </div>
  </div>
  <SundayLiveDesk/>
</section>
