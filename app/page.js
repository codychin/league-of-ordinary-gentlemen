...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    <Link href="/articles/hollis-kash-folder" className="sundayFeature storylink">
      <div className="sundayFeatureImage athleteFeature"><img src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['hopkins-opus']))} alt="Hopkins Opus featured player"/><img className="featureOpponent" src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['royrek']))} alt="Royrek featured player"/><div className="evidenceStamp">HOPKINS–ROYREK<br/>EVIDENCE PRESERVATION</div></div>
      <div className="sundayFeatureCopy"><small>INVESTIGATIONS • THE EVIDENCE LOCKER</small><h2>The Man at the End of the Bar Had a Folder With Kash’s Name on It.</h2><p>Somewhere between LaGuardia and last call, a stranger decided Hopkins–Royrek required documentation.</p><PreviewAuthor slug="hollis-kash-folder"/><span>OPEN THE FILE →</span></div>
    </Link>
    <div className="sundaySide">
      <Link href="/articles/maude-sunday-board-week-2" className="sundaySideStory storylink"><div className="sideImage athleteSide"><img src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['all-ugly']))} alt="All Ugly featured player"/><b>FILM ROOM</b></div><small>MAUDE GANNON • FOOTBALL</small><h3>Three Decisions I Would Actually Care About</h3><p>Three choices where the evidence is clean enough that Sunday cannot be blamed afterward.</p><span>READ THE BOARD →</span></Link>
      <Link href="/articles/dashiell-route-22-portfolio" className="sundaySideStory storylink"><div className="sideImage athleteSide"><img src={playerHeadshot(featuredPlayer(leagueSnapshot.teams['route-22']))} alt="Route 22 featured player"/><b>CAPITAL DESK</b></div><small>DASHIELL PIKE • CAPITAL</small><h3>Route 22 Is Winning and Would Still Like to Restructure the Company</h3><p>James Cook scored 27. Route 22 responded by keeping the market open.</p><span>FOLLOW THE MONEY →</span></Link>
    </div>
  </div>
  <div className="sundayDesks">
    <div className="desksLabel"><small>FROM THE DESKS</small><b>The newsroom, before anyone has technically done anything wrong.</b></div>
    <div className="deskVoice"><img src={writers.sorrell.image} alt=""/><span><small>CONRAD SORRELL</small><b>“By 1:17 somebody will describe a lineup decision as an institution. I intend to find out who benefits.”</b></span></div>
    <div className="deskVoice"><img src={writers.march.image} alt=""/><span><small>SABINE MARCH</small><b>“Six bilateral disputes begin at one. Several family relationships remain exposed.”</b></span></div>
    <div className="deskVoice"><img src={writers.kells.image} alt=""/><span><small>MARNIE KELLS</small><b>“I’m not filing culture because it’s Sunday. Somebody famous will have to embarrass themselves first.”</b></span></div>
  </div>
  <div className="sundayUtility"><span><small>THURSDAY RECEIPT</small><b>Josh Allen • 45.22</b></span><span><small>EARLY EVIDENCE</small><b>Amon-Ra • 36.2</b></span><span><small>MARKET ACTIVITY</small><b>James Cook • 27.0</b></span><span><small>NEXT</small><b>Live Desk • 12:30 PM</b></span></div>
