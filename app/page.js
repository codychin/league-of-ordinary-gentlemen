...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    <Link href="/articles/maude-sunday-board-week-2" className="sundayFeature storylink">
      <div className="sundayFeatureImage sundayActionHero"><img src="https://s.hdnux.com/photos/01/55/52/46/28748196/3/rawImage.jpg" alt="Caleb Williams in game action"/><div className="actionCaption">MAUDE'S SUNDAY BOARD • WEEK 2</div></div>
    ...
    <div className="sundaySide sundayStoryCarousel" aria-label="Sunday supporting stories">
      <Link href="/articles/hollis-kash-folder" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/private/t_editorial_landscape_12_desktop/lions/njpa8b1s1hscatyopyxu" alt="NFL game action"/><b>STORY 2 • MATCHUP FILE</b></div><small>HOLLIS CRANE • HOPKINS–ROYREK</small><h3>181.60 Is Now Admissible Evidence</h3><p>Hopkins Opus has the Week 1 high score. Royrek gets the first chance to make it old news.</p><span>READ →</span></Link>
      <Link href="/articles/sabine-all-ugly-lloyd" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://s.yimg.com/ny/api/res/1.2/0Y5cGrbAtqCkb2U7TKlVtg--/YXBwaWQ9aGlnaGxhbmRlcjt3PTEyMDA7aD04MDA-/https://media.zenfs.com/en/detroit_free_press_usa_today_sports_articles_655/7b8f3c7040c4f42e1afba04e67b908bf" alt="Detroit Lions game action"/><b>STORY 3 • GAME FILE</b></div><small>SABINE MARCH • ALL UGLY–LLOYD</small><h3>Thursday Made the Closest Game on the Board Even Closer</h3><p>Amon-Ra and Kincaid have already traded 59.7 points. The projection is separated by less than one.</p><span>READ →</span></Link>
      <Link href="/articles/conrad-danir-ceedeep-hole" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/upload/t_landscape_tablet/lions/jahmyr-gibbs-action.jpg" alt="Jahmyr Gibbs in game action"/><b>STORY 4 • EARLY DAMAGE</b></div><small>CONRAD SORRELL • DANIR–CEEDEEP</small><h3>Danir Hasn't Reached Sunday and Is Already Down 29.12</h3><p>Gibbs answered. The problem is that CeeDeep started Thursday with 53.02.</p><span>READ →</span></Link>
    </div>
  </div>
  <SundayLiveDesk/>
</section>
