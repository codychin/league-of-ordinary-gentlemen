...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    <Link href="/articles/hollis-kash-folder" className="sundayFeature storylink">
      <div className="sundayFeatureImage"><img src={writers.crane.image} alt={writers.crane.imageAlt}/><div className="evidenceStamp">HOLLIS CRANE<br/>FIELD NOTES • 12:41 A.M.</div></div>
      <div className="sundayFeatureCopy"><small>INVESTIGATIONS • THE EVIDENCE LOCKER</small><h2>The Man at the End of the Bar Had a Folder With Kash’s Name on It.</h2><p>Hopkins Opus plays Royrek today. Somewhere between LaGuardia and last call, a stranger decided this required documentation.</p><PreviewAuthor slug="hollis-kash-folder"/><span>OPEN THE FILE →</span></div>
    </Link>
    <div className="sundaySide">
      <Link href="/articles/maude-sunday-board-week-2" className="sundaySideStory storylink"><div className="sideImage"><img src={writers.gannon.image} alt={writers.gannon.imageAlt}/><b>FILM ROOM</b></div><small>MAUDE GANNON • FOOTBALL</small><h3>Three Decisions I Would Actually Care About</h3><p>No injury-crawl theater. Just the choices where the football and the manager are actually in conflict.</p><span>READ THE BOARD →</span></Link>
      <Link href="/articles/dashiell-route-22-portfolio" className="sundaySideStory storylink"><div className="sideImage"><img src={writers.pike.image} alt={writers.pike.imageAlt}/><b>CAPITAL DESK</b></div><small>DASHIELL PIKE • CAPITAL</small><h3>Route 22 Is Winning and Would Still Like to Restructure the Company</h3><p>James Cook scored 27. Management has responded by discovering activist investing.</p><span>FOLLOW THE MONEY →</span></Link>
    </div>
  </div>
