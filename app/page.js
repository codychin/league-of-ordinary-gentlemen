...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    ...
    <div className="sundaySide sundayStoryCarousel" aria-label="Sunday supporting stories">
      ...
      <Link href="/articles/sabine-all-ugly-lloyd" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://images2.minutemediacdn.com/image/upload/c_crop,w_3000,h_3000,x_0,y_0/c_fill,w_1200,ar_16:9,f_auto,q_auto,g_auto/images/voltaxMediaLibrary/mmsport/kicks/01k4qfs4xvxp4qw5gqbn.jpg" alt="NFL game action"/><b>STORY 3 • GAME FILE</b></div><small>SABINE MARCH • ALL UGLY–LLOYD</small><h3>Thursday Made the Closest Game on the Board Even Closer</h3><p>Amon-Ra and Kincaid have already traded 59.7 points. The projection is separated by less than one.</p><span>READ →</span></Link>
      <Link href="/articles/conrad-danir-ceedeep-hole" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/private/t_editorial_landscape_12_desktop/lions/njpa8b1s1hscatyopyxu" alt="NFL game action"/><b>STORY 4 • EARLY DAMAGE</b></div><small>CONRAD SORRELL • DANIR–CEEDEEP</small><h3>Danir Hasn't Reached Sunday and Is Already Down 29.12</h3><p>Gibbs answered. The problem is that CeeDeep started Thursday with 53.02.</p><span>READ →</span></Link>
    </div>
  </div>
  <SundayLiveDesk/>
</section>
