...
<section className="morningBriefPreview" aria-label="Sunday Morning Brief editorial preview">
  <div className="morningBriefFlag"><span>THE SUNDAY MORNING BRIEF</span><small>WEEK 2 • SUNDAY, SEPTEMBER 20 • EDITORIAL PREVIEW</small></div>
  <div className="morningBriefLead">
    <div>
      <span className="morningBriefEdition">THE MATCHUP FILE • FAMILY BUSINESS</span>
      <h2>All Ugly and Lloyd Meet Again. Unfortunately, This Time the Family Has Evidence.</h2>
      <p>One week into the season, the league's most useful relationships are already becoming liabilities. Sunday begins with old history, new screenshots and several organizations insisting none of this is personal.</p>
    </div>
    <aside><small>FIRST KICK</small><b>1:00</b><span>PM ET</span></aside>
  </div>
  <div className="morningBriefGrid">
    <article><small>MAUDE GANNON • FOOTBALL</small><b>Three decisions I would actually care about</b><p>Forget the injury crawl. Maude isolates the usage, matchup and lineup choices where the football says something different from the room. If somebody ignores the evidence because a projection moved two points, she reserves the right to call him a bitch.</p><span>MAUDE'S SUNDAY BOARD →</span></article>
    <article><small>HOLLIS CRANE • INVESTIGATIONS</small><b>Kash has new evidence. Nobody requested it.</b><p>Hopkins Opus and Royrek arrive Sunday with another file apparently open. Hollis is less interested in the projection than in why evidence keeps materializing around the same people.</p><span>OPEN THE FILE →</span></article>
    <article><small>DASHIELL PIKE • CAPITAL</small><b>Route 22 spent the week shopping. James Cook already scored 27.</b><p>An organization that has tried to acquire half the league now enters Sunday with proof that one of the players it already employed was perfectly capable of doing the job.</p><span>FOLLOW THE MONEY →</span></article>
  </div>
  ...
  <div className="morningBriefFooter"><b>THE NEWSROOM IS AWAKE.</b><span>Morning edition 8:30 AM • Live Desk begins 12:30 PM • Roundtable push at 1:00 PM</span></div>
</section>
