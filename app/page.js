...
<section className="hero heroStack" id="league"><Link className="hero-copy storylink" href="/articles/hollis-body-keeps-score"><div className="photoHero" style={{backgroundImage:"linear-gradient(0deg,rgba(0,0,0,.42),rgba(0,0,0,.06)),url('/images/editorial/hollis-body-score.jpg')"}}><div><small>HOLLIS CRANE • FIELD NOTES</small><b>The body</b><strong>—</strong><span>KEEPS SCORE</span></div></div><div className="eyebrow">SUNDAY NIGHT • FIELD NOTES</div><h2>The Body Keeps <em>the Real Score.</em></h2><PreviewAuthor slug="hollis-body-keeps-score"/><p className="standfirst">Fantasy football gives us a contained place to pretend control exists. Then a hamstring goes. An elbow bends. And the structure reveals itself.</p><div className="read">READ HOLLIS →</div></Link></section>
