...
<section className="morningBriefPreview" aria-label="Sunday Morning Brief design preview">
  <div className="morningBriefFlag"><span>THE SUNDAY MORNING BRIEF</span><small>WEEK 2 • PRE-GAME EDITION • DESIGN PREVIEW</small></div>
  <div className="morningBriefLead">
    <div>
      <span className="morningBriefEdition">GOOD MORNING, GENTLEMEN</span>
      <h2>Six Games. Several Bad Decisions. One Entire Sunday to Explain Them.</h2>
      <p>The league wakes up with Thursday already on the books, six matchups still live and approximately four hours remaining before every manager becomes certain the projections are wrong.</p>
    </div>
    <aside><small>FIRST KICK</small><b>1:00</b><span>PM ET</span></aside>
  </div>
  <div className="morningBriefGrid">
    <article><small>MAUDE'S BOARD</small><b>What actually matters today</b><p>Injuries, late-week usage and the lineup decisions with enough leverage to ruin lunch.</p><span>FOOTBALL STRATEGY →</span></article>
    <article><small>THE MATCHUP FILE</small><b>Pressure is not evenly distributed</b><p>Thursday created an early deficit. Elsewhere, several managers remain innocent only because nobody has played yet.</p><span>SIX GAMES →</span></article>
    <article><small>OVERNIGHT DESK</small><b>What changed while you were asleep</b><p>News, transactions, questionable tags and any fresh evidence the newsroom considers actionable or funny.</p><span>THE WIRE →</span></article>
  </div>
  <div className="morningBriefFooter"><b>THE NEWSROOM IS AWAKE.</b><span>Live Desk takes over when the games do.</span></div>
</section>
