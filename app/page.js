...
<section className="morningBriefPreview sundayFront" aria-label="Sunday Morning Brief">
  ...
  <div className="sundayFrontGrid">
    ...
    <div className="sundaySide sundayStoryCarousel" aria-label="Sunday supporting stories">
      <Link href="/articles/sabine-all-ugly-lloyd" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/private/t_editorial_landscape_12_desktop/lions/njpa8b1s1hscatyopyxu" alt="Amon-Ra St. Brown in Week 2 game action"/><b>STORY 2 • GAME FILE</b></div><small>SABINE MARCH • ALL UGLY–LLOYD</small><h3>The Closest Game on the Board Lost Zay Flowers and Barely Moved</h3><p>Flowers is out. The projection is still separated by only a few points.</p><span>READ →</span></Link>
      <Link href="/articles/conrad-kupp-kraft-keenan" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/upload/t_editorial_landscape_12_desktop/bills/ylei6bbqmwbzo0xqil0i" alt="DJ Moore in Week 2 game action"/><b>STORY 3 • ROSTER MOVE</b></div><small>CONRAD SORRELL • KUPP–KRAFT</small><h3>Kupp Kupp Doubs Added Keenan Allen at Breakfast</h3><p>DJ Moore's shoulder explains the timing. Puka's Monday status keeps the other side interesting.</p><span>READ →</span></Link>
      <Link href="/articles/conrad-danir-ceedeep-hole" className="sundaySideStory storylink"><div className="sideImage sundaySecondaryAction"><img src="https://static.clubs.nfl.com/image/upload/t_editorial_landscape_12_desktop/lions/lvqxmtstifz3kn8ckfxi" alt="Jahmyr Gibbs catching a touchdown against Buffalo"/><b>STORY 4 • EARLY DAMAGE</b></div><small>CONRAD SORRELL • DANIR–CEEDEEP</small><h3>Danir Hasn't Reached Sunday and Is Already Down 29.12</h3><p>Gibbs answered. The problem is that CeeDeep started Thursday with 53.02.</p><span>READ →</span></Link>
    </div>
  </div>
  <SundayLiveDesk/>
</section>
<section className="hero heroStack" id="league"><Link className="hero-copy storylink" href="/articles/maude-jayden-daniels-elbow"><div className="eyebrow">SUNDAY NIGHT • INJURY FILE</div><div className="photoHero" style={{backgroundImage:"linear-gradient(0deg,rgba(0,0,0,.38),rgba(0,0,0,.04)),url('https://static.clubs.nfl.com/image/upload/t_editorial_landscape_12_desktop/commanders/ndk0t8ptjomvclq61jzx')"}}><div><small>WASHINGTON / WEEK 2</small><b>Jayden Daniels</b><strong>2×</strong><span>SAME ELBOW</span></div></div><h2>Jayden Daniels Has Dislocated the Same Elbow <em>Twice in 10 Months.</em></h2><PreviewAuthor slug="maude-jayden-daniels-elbow"/><p className="standfirst">Initial X-rays show no fracture. Further testing is coming. The recurrence is still the part nobody can make sound normal.</p><div className="read">READ THE INJURY FILE →</div></Link></section>
